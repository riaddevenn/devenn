...
<template>
  ...
  >
    <!-- Title bar -->
    <div class="absolute inset-x-0 top-0 flex h-[14px] items-center gap-[4.2px] rounded-t-[5.6px] bg-white/70 pl-[6.3px]">
    ...
    <!-- Screen -->
    <div class="absolute inset-x-0 top-[14px] bottom-0 overflow-hidden rounded-[2.8px] px-[3.15px] py-[3.5px]">
